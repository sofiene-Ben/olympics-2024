...
@offer_bp.get('/api/show-offer/<int:offer_id>')
def show_offer(offer_id):
    offer = Offer.query.get(offer_id)

    if not offer:
        return {"message": "aucune offre n'a ete trouve"}
...
@offer_bp.delete('/api/delete_offer/<int:offer_id>')
def delete_offer(offer_id):
    # Récupérer l'offre à supprimer en utilisant l'ID
    offer = Offer.query.get(offer_id)
